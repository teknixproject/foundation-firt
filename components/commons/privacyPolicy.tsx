      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-10">
          <p className="text-lg leading-relaxed">
            At TBK Best, accessible from tbkbest.com, one of our main priorities is the privacy of
            our visitors. This Privacy Policy document contains types of information that is
            collected and recorded by TBK Best and how we use it.
          </p>
          ...
          <p className="text-lg leading-relaxed mt-4">
            ...
            our website with regards to the information that they shared and/or collect in TBK Best.
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 mt-4 space-y-2 text-lg leading-relaxed">
            ...
            <li>
              <strong>Application</strong> refers to TBK Best, the software program provided by the
              Company.
            </li>
            <li>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
              this Agreement) refers to TBK Best, 1234 Privacy Lane, Data City, TX 56789.
            </li>
            <li>
        ...
        <section className="mb-10">
          ...
          <p className="text-lg leading-relaxed mt-4">
            Please note, however, that We may need to retain certain information when we have an
            ongoing legitimate business need to do so (for example, to comply with applicable legal,
        ...
        {/* Footer note */}
        <p className="text-sm text-gray-500 mt-12">Generated using Free Privacy Policy Generator</p>
      </div>
    </div>
  );
};
