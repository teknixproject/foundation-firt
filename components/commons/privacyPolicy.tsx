    ...
    <div className="bg-white text-black min-h-screen py-12 px-6 md:px-12 lg:px-24">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-600 mb-8">
          <a
            href="https://www.freeprivacypolicy.com/live/7f8c0c-cca5-1c8b-b0db-0b2e2a0c"
            className="underline text-blue-600"
          >
            https://www.freeprivacypolicy.com/live/7f8c0c-cca5-1c8b-b0db-0b2e2a0c
          </a>
        </p>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 mt-4 space-y-2 text-lg leading-relaxed">
            ...
            <li>
              <strong>Application</strong> refers to Lalala Cafe, the software program provided by
              the Company. Company (referred to as either "the Company", "We", "Us" or "Our" in this
              Agreement) refers to TEKAWAY JOINT STOCK COMPANY, 1B/1 Khu vực 3, Phường An Khánh,
              Quận Ninh Kiều, Thành phố Cần Thơ, Việt Nam.
            </li>
            <li>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
              this Agreement) refers to TEKAWAY JOINT STOCK COMPANY, 1B/1 Khu vực 3, Phường An
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-[#4F81BD]">Retention of Your Personal Data</h2>
          <p className="text-lg leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-[#4F81BD]">Transfer of Your Personal Data</h2>
          <p className="text-lg leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-[#4F81BD]">Disclosure of Your Personal Data</h2>
          ...
          <h3 className="text-xl font-medium mt-6 mb-2 text-[#4F81BD] italic">Other Legal Requirements</h3>
          <p className="text-lg leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-[#4F81BD]">Security of Your Personal Data</h2>
          <p className="text-lg leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-[#4F81BD]">Changes to this Privacy Policy</h2>
          <p className="text-lg leading-relaxed">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 mt-4 space-y-2 text-lg leading-relaxed">
            <li>
              By email:{' '}
              <a href="mailto:support@lalacafe.com" className="underline text-blue-600">
                support@lalacafe.com
              </a>
            </li>
            <li>
              By visiting this page on our website:{' '}
              <a href="https://support.lalacafe.com" className="underline text-blue-600">
                https://support.lalacafe.com
              </a>
            </li>
          </ul>
        </section>
